...
def get_pagination(context, first_last_amount=2, before_after_amount=4):
    ...
    if page.number > first_last_amount + before_after_amount:
        ...
        for i in range(page.number - before_after_amount, page.number):
            page_numbers.append(i)
    ...
    if page.number + first_last_amount + before_after_amount < paginator.num_pages:
        for i in range(page.number, page.number + before_after_amount + 1):
            page_numbers.append(i)
        ...
        for i in range(page.number, paginator.num_pages + 1):
            page_numbers.append(i)
